...
import './PlaneacionPresupuesto.css';
...
export default function PlaneacionPresupuesto() {
    ...
    return (
        <div className="planeacion-presupuesto-container fade-in">
            {/* Custom Header */}
            ...
            <div className="budget-title-row">
                <Group gap="sm">
                    <IconReportAnalytics size={28} color="#94a3b8" />
                    <Title order={3} c="white">Gestión de Presupuestos Planeación</Title>
                </Group>
                <Group gap="xs">
