...
export default function SstPresupuesto() {
    ...
    return (
        <div className="sst-presupuesto-container fade-in">
            {/* Custom Header */}
            ...
            <div className="budget-title-row">
                <Group gap="sm">
                    <IconShieldCheck size={28} color="#94a3b8" />
                    <Title order={3} c="white">Gestión de Presupuestos SST</Title>
                </Group>
                <Group gap="xs">
