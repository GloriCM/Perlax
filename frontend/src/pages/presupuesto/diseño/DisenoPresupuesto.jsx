...
export default function DisenoPresupuesto() {
    ...
    return (
        <div className="diseno-presupuesto-container fade-in">
            {/* Custom Header */}
            ...
            <div className="budget-title-row">
                <Group gap="sm">
                    <IconPalette size={28} color="#94a3b8" />
                    <Title order={3} c="white">Gestión de Presupuestos Diseño</Title>
                </Group>
                <Group gap="xs">
