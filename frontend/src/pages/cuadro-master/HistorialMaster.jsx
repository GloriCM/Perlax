...
/** Historial del Cuadro Master (tabla simple). El explorador multi-operario vive solo en Reporte Diario. */
            ...
            <Container size="100%" px="md" pb="xl">
                <Paper p="xl" radius="lg" style={{ background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                    <Group justify="center" mb="xl">
                        <Title order={2} c="white" fw={800}>Historial Master</Title>
                    </Group>
                    ...
                    <Paper p="md" mb="lg" style={{ background: 'transparent' }}>
                        <Group justify="space-between">
                            ...
                            <Stack align="center" gap={5}>
                                ...
                                <Group gap={5} style={{ background: 'rgba(255,255,255,0.05)', padding: '5px 15px', borderRadius: '4px' }}>
                    ...
                    <Stack gap={4} mb="xl">
                        <Button fullWidth size="lg" color="blue.6" leftSection={<IconRefresh size={20} />} fw={700}>
                            Actualizar Ahora
                        </Button>
                    </Stack>
                    ...
                    <Center mt="md">
                        <Text size="xs" c="dimmed">
                            El historial multi-operario (panel tipo Aleph) está en Reporte Diario.
                        </Text>
                    </Center>
                </Paper>
            </Container>
